...
import { ScrollArea } from "@/components/ui/co/scroll-area"
import { PhoneInputProps } from "./phone-input.props"
import { phoneInputTheme } from "@/theme/phone-input.theme"
import { cn } from "@/utils/css-class-name.utility"

const PhoneInput: React.ForwardRefExoticComponent<PhoneInputProps> =
  React.forwardRef<React.ElementRef<typeof RPNInput.default>, PhoneInputProps>(
    ({ className = phoneInputTheme.className, onChange, ...props }, ref) => {
      return (
        <RPNInput.default
          ref={ref}
          {...phoneInputTheme}
          ...
          inputComponent={InputComponent} // TODO: use CoInput in here
          smartCaret={false}
          international={true}
          /**
...
//       <Input
//         ref={ref}
//         className={textInputDefaultProps.className}
//         {...props}
//         type="text"
//       />
//     )
