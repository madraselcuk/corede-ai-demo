...
import { NotificationListContainerUIProps } from '../notification-list.container'
import { Button } from '@/components/ui/Button'
import { useI18n } from '@/localization/hooks/useI18n'
import { NoConnectionState } from '@/components/organisms/no-connection-state/no-connection-state'

export const NotificationListTableUI = (props: NotificationListContainerUIProps) => {
  const { t } = useI18n()
...
export default NotificationListTableUI
