...
export interface BlogListEditorsChoicePublicContainerUIProps {
...
export interface BlogListEditorsChoicePublicContainerProps {
  readonly children: (
    props: BlogListEditorsChoicePublicContainerUIProps,
  ) => JSX.Element | undefined
}

export const BlogListEditorsChoicePublicContainer = ({
  children,
}: BlogListEditorsChoicePublicContainerProps) => {
  const { t } = useI18n()
  ...
  console.log('editors choice', blogListData)
...
export default BlogListEditorsChoicePublicContainer
