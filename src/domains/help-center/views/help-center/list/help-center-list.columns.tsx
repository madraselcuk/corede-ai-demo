...
import { IHelpCenterCategory, IHelpCenterListItemResult } from '@corede_package'
import { ColumnDef } from '@tanstack/react-table'

export function helpCenterColumnDefs(params: {
  onEdit: (helpCenter: IHelpCenterListItemResult) => void
  onDelete: (helpCenter: IHelpCenterListItemResult) => void
}): ColumnDef<IHelpCenterListItemResult>[] {
  const { t } = useI18n()

  return getColumnDefs<IHelpCenterListItemResult>({
    selectColumn: {
      enabled: true,
    },
    actionsColumnDef: {
    ...
    additionalColumns: [
      ...
      getEntityProfileColumnDef<IHelpCenterListItemResult, IHelpCenterCategory>(
        {
