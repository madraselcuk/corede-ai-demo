...
import { ISubscriptionFormUpdateInput } from '@corede_package'
...
import {
  ...
  useSubscriptionFormUpdateMutation,
} from '@/domains/form/api'
export interface SubscriptionFormUpdateFormInputs
  extends IGraphqlVariables<ISubscriptionFormUpdateInput> {}
