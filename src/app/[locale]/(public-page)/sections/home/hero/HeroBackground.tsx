...
const HeroBackground = () => {
  ...
  return (
    <>
      ...
      <div className="absolute inset-0">
        ...
        >
          ...
          <defs>
            ...
            >
              <stop offset="0.51" stopColor="#00E5FF" stopOpacity="0.7"></stop>
              <stop offset="0.75" stopColor="#8A2BE2" stopOpacity="0.7"></stop>
              <stop offset="0.86" stopColor="#8A2BE2" stopOpacity="0.7"></stop>
              <stop offset="1" stopColor="#FF007F" stopOpacity="0.7"></stop>
            </linearGradient>
            <radialGradient
      ...
      {/* Yoğunlaşan karanlık/aydınlık overlay */}
      <div className={`absolute inset-0 bg-gradient-to-b ${
        isDarkMode ? 'from-transparent to-black/50' : 'from-transparent to-white/50'
      }`}></div>
    </>
  )
}
