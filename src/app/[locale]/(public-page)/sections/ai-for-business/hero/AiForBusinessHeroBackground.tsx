...
const AiForBusinessHeroBackground = () => {
          ...
          <defs>
            ...
            >
              <stop
                offset="0.51"
                stopColor="#8A2BE2"
                stopOpacity={isDarkMode ? '0.7' : '0.4'}
              ></stop>
              <stop
                offset="0.75"
                stopColor="#4A0D9A"
            ...
            <radialGradient
              ...
              r="1"
              gradientUnits="userSpaceOnUse"
              gradientTransform="translate(756 388.101) rotate(90) scale(427.899 845.73)"
            >
              <stop
...
export default AiForBusinessHeroBackground
