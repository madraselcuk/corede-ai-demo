...
const AiTransformationRight = () => {
  ...
  return (
    ...
    >
      <div
        className="flex flex-col-reverse md:flex-col gap-4 bg-slate-100 dark:bg-slate-900
      ...
      >
        <div className="flex flex-col gap-4 flex-1 p-4 md:p-8 ">
          ...
          <ul className="list-disc list-inside text-slate-800 dark:text-slate-100 text-xs md:text-xl">
            <li>{t('section-2.item-1')}</li>
            <li>{t('section-2.item-2')}</li>
            <li>{t('section-2.item-3')}</li>
          </ul>
        </div>
...
export default AiTransformationRight
