...
const AiPoweredSolutionsLeft = () => {
  ...
  return (
    ...
    >
      <div
        className="flex flex-col gap-4 bg-gradient-to-t from-primary/50 to-transparent
        ...
        <div
          className="flex flex-col gap-4 flex-1 border border-slate-600 dark:border-gray-200/40 rounded-2xl
            dark:bg-[url('/img/others/ai-solutions/ai-powered-bg-pattern.png')] 
             bg-repeat bg-center bg-clip-content  h-h-[130px]  "
        >
          <div
          ...
          >
            <img
              src="/img/others/ai-solutions/Play.png"
              alt="ai-powered-bg-pattern"
              className="w-1/8"
            />
            <img
              src="/img/others/ai-solutions/iPhone.png"
              alt="ai-powered-bg-pattern"
              className="w-1/3 self-end"
              
            />
            <img
              src="/img/others/ai-solutions/Symbol.png"
              alt="ai-powered-bg-pattern"
              className="w-1/8"
            />
          </div>
...
export default AiPoweredSolutionsLeft
