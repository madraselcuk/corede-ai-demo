...
import AiSolutionsStatistics from './AiSolutionsStatistics'
const AiSolutionsHeroContent = () => {
  const t = useTranslations('pages.aiSolutions.hero')
...
export default AiSolutionsHeroContent
